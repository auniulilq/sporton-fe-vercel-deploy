...
const Header = () => {
  const [isChartPopupOpen, setIsCartPopupOpen] = useState(false);
    ...
    <header>
      <div className="flex justify-between gap-10 container mx-auto py-7">
        ...
        <div className="relative flex gap-10">
          <FiSearch size={24} />
          <button className="relative cursor-pointer" onClick={() => setIsCartPopupOpen(!isChartPopupOpen)}
            >
