    ...
    return (
        <main className="container mx-auto py-40 flex gap-12">
            <div className="bg-primary-light aspect-square min-w-140 flex justify-center items-center">
                <Image src="/images/products/product-4.svg" width={550} height={550} alt="product 4 image" className="aspect-square object-contain -full" />
            </div>
            <div className="w-full py-7">
                <h1 className="font-bold italic text-5xl text-center mb-6">
                    SportOn HyperSocer v2
                </h1>
